...
function querySQL() {
	...
	$sql[] = "CREATE TABLE `".$mysql_prefix."guestbook` ( `id` int(10) unsigned NOT NULL auto_increment, `date` varchar(20) default NULL, `username` varchar(50) default '游客', `email` varchar(100) default NULL, `ip` varchar(20) default NULL, `content` text, `reply` text, PRIMARY KEY (`id`)) TYPE=MyISAM;";
	...
	$sql[] = "CREATE TABLE `".$mysql_prefix."link` ( `id` int(5) unsigned NOT NULL auto_increment, `sitename` varchar(100) default NULL, `linkurl` varchar(80) default NULL, `alt` text NOT NULL, `showorder` int(10) unsigned NOT NULL default '0', `linkhidden` int(10) default NULL, PRIMARY KEY (`id`)) TYPE=MyISAM;";
	...
	$sql[] = "CREATE TABLE `".$mysql_prefix."loginlog` ( `id` int(10) NOT NULL auto_increment, `username` varchar(100) NOT NULL default '', `date` varchar(20) NOT NULL default '', `ip` varchar(20) NOT NULL default '', `result` int(10) NOT NULL default '0', PRIMARY KEY (`id`)) TYPE=MyISAM;";

	$sql[] = "drop table if exists `".$mysql_prefix."note`;";
	$sql[] = "CREATE TABLE `".$mysql_prefix."note` ( `id` int(10) unsigned NOT NULL auto_increment, `date` varchar(20) default NULL, `title` varchar(200) default NULL, `content` text, PRIMARY KEY (`id`)) TYPE=MyISAM;";
